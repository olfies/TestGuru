...
user1 = User.create(name: 'Глеб', email: 'dota2@mail.ru', password: 'qwe123')
user2 = User.create(name: 'Андрей', email: 'csgo2@gmail.ru', password: 'zxcqwe')
user3 = User.create(name: 'Маша', email: 'worldoftanks@yandex.ru', password: 'zxc123')
